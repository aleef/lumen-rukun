...
<body>
    ...
    <div class="main">
        <div class="sub-main">
            ...
            @if($is_approve)
                <div class="paragraph">
                    <span style="font-size:14px;"><strong>Selamat Anda sudah tergabung ke Wilayah {{$nama_wilayah}}</strong></span>
                    <p>
                        Silakan login pada aplikasi Rukun menggunakan username dan password yang sudah dibuat.
                    </p>
                    <p>
                        Pesan ini dikirim oleh Rukun dan untuk tidak dibalas.
                    </p>
                </div>
            @else
                <div class="paragraph">
                    <span style="font-size:14px;"><strong>Permintaan Anda bergabung ke Wilayah {{$nama_wilayah}} ditolak </strong></span>
                    <p>
                        Pengurus tidak mengijinkan Anda tergabung ke wilayah. Silakan kontak Pengurus untuk lebih lanjut.
                    </p>
                    <p>
                        Pesan ini dikirim oleh Rukun dan untuk tidak dibalas.
                    </p>
