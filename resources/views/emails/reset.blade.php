...
<body>
    ...
    <div class="main">
        <div class="sub-main">
            ...
            <div class="paragraph">
                <span style="font-size:14px;"><strong>Halo {{ $name }}, </strong></span>
                <p>{{ $message_1 }} </p> <br> <p> {{ $message_2 }} </p><br><br>
                <a href="{{ url('') }}/warga/resetpassword/{{ $warga_id }}/{{ $wil_id }}" class="registrasi">RESET KATA SANDI</a>

                <p>
                    Pesan ini dikirim melalui Aplikasi Rukun.
                </p>
            </div>
        </div>
        <div class="footer">
